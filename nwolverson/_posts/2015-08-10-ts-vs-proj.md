...
![Virtual Project]({{site.github.url}}/nwolverson/assets/vstsproj/virtualproject.png)
...
![Basic virtual projects]({{site.github.url}}/nwolverson/assets/vstsproj/basic-virtual-projects.png)
...
Having surveyed the options for a project involving WebWorkers, what about TypeScript targetting Node.js? A definitions file is available for Node, giving access to all the standard APIs, but when we consider APIs available in the browser but not under Node, we have the same `lib.d.ts` issue:
