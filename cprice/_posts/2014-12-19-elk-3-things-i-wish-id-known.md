...
![ELK Overview]({{ site.baseurl }}/cprice/assets/ELKOverview.png "ELK Overview")
...
![Kibana 4 beta 3]({{ site.baseurl }}/cprice/assets/Kibana4beta3.png "Kibana 4 beta 3 (taken from the release blog post)")
...
![An example chart showing the concurrent session lifecyle overview in Kibana]({{ site.baseurl }}/cprice/assets/ELKSessionLifecycle.png "An example chart showing the concurrent session lifecyle overview in Kibana")
