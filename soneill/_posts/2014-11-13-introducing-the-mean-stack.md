...
<h2 style="text-indent: -9999px; background-image:url('{{ site.baseurl }}/soneill/assets/2014-11-13-introducing-the-mean-stack/what-header.png'); height:265px; background-repeat: no-repeat; background-position: center;" class="aligncenter">What is MEAN.IO</h2>
...
<img title="mongodb" class="alignleft" src="{{ site.baseurl }}/soneill/assets/2014-11-13-introducing-the-mean-stack/mongologo.svg"/>
...
<img title="node" class="alignleft" src="{{ site.baseurl }}/soneill/assets/2014-11-13-introducing-the-mean-stack/nodelogo.svg"/>
...
<img title="express" class="alignleft" src="{{ site.baseurl }}/soneill/assets/2014-11-13-introducing-the-mean-stack/express.png"/>
...
<img title="angular" class="alignleft" src="{{ site.baseurl }}/soneill/assets/2014-11-13-introducing-the-mean-stack/angularlogo.svg"/>
...
<h2 style="text-indent: -9999px; background-image:url('{{ site.baseurl }}/soneill/assets/2014-11-13-introducing-the-mean-stack/install-header.png'); height:206px; background-repeat: no-repeat; background-position: center;" class="aligncenter">Install MEAN.IO</h2>
...
<h2 style="text-indent: -9999px; background-image:url('{{ site.baseurl }}/soneill/assets/2014-11-13-introducing-the-mean-stack/hello-header.png'); height:243px; background-repeat: no-repeat; background-position: center;" class="aligncenter">Hello, World! In MEAN.IO</h2>
...
<h2 style="text-indent: -9999px; background-image:url('{{ site.baseurl }}/soneill/assets/2014-11-13-introducing-the-mean-stack/develop-header.png'); height:200px" class="aligncenter">Developing the mean stack</h2>
