...
### Black Box Goodness  
If we have a look at the requirement above we can split them into two black box requirements (Working and Efficient) and two white box requirements (Maintainable and Extensible). that means two out of the four requirements can be tested for without ever looking at a single line of code.   
...
As developers looking at code, I think we can layout our requirements for what we want from the code in the following way:  
