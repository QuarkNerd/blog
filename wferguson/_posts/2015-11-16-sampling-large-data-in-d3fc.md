...
These algorithms were implemented in `fc.data.sampler`, and using them is easy. Setting up the sampler is a case of telling it how big the buckets should be, and where it should look for the data.
...
The chart has two components -- the main viewport and the low barrel providing an overview of the entire dataset. Both of these components were subsampled to improve performance. The low barrel through Largest Triangle Three Bucket, and the main viewport through the user's choice (or none at all) in order to compare the algorithms.
...
Have a play below and try it for yourself! If you're interested in learning more, check out the [d3fc website](http://d3fc.io/) or the [d3fc GitHub](https://github.com/ScottLogic/d3fc).

<iframe src="http://wpferg.github.io/d3fc-samplers" style="width: 100%; height: 500px; border: none; overflow: hidden;"></iframe>

The code for this example is available on [GitHub](https://github.com/WPFerg/wpferg.github.io/tree/master/d3fc-samplers).
